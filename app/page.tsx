...
export default async function Home() {
  const [airdrops, dbTestimonials] = await Promise.all([getAllAirdrops(), getTestimonials()]);
    ...
    <>
      ...
      <style>{`
        ...
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        /* MISC */
        .content { max-width: 1600px; margin: 0 auto; padding: 0 24px; }
        ...
        .cc-section { padding:40px 24px; }
        .cc-inner { max-width:800px; margin:0 auto; }
        .cc-hdr { text-align:center; margin-bottom:24px; }
        .cc-tag { font-size:10px; font-weight:700; letter-spacing:0.1em; text-transform:uppercase; color:rgba(255,255,255,0.2); margin-bottom:6px; }
        .cc-title { font-size:clamp(18px,2.5vw,24px); font-weight:900; letter-spacing:-0.03em; color:#fff; margin-bottom:4px; }
        .cc-sub { font-size:12px; color:rgba(255,255,255,0.3); }
        .cc-cards { display:grid; grid-template-columns:1fr 1fr; gap:12px; }
        .cc-card { border-radius:16px; padding:20px; display:flex; flex-direction:column; gap:14px; }
        .cc-card-kast { background:linear-gradient(135deg,#0d1b3a,#091428); border:1px solid rgba(79,142,247,0.18); }
        .cc-card-redot { background:linear-gradient(135deg,#180d2e,#100820); border:1px solid rgba(168,85,247,0.18); }
        .cc-row1 { display:flex; justify-content:space-between; align-items:center; }
        .cc-brand { font-size:15px; font-weight:900; letter-spacing:-0.02em; }
        .cc-brand-kast { color:#4f8ef7; }
        .cc-brand-redot { color:#a855f7; }
        .cc-badge { font-size:9px; font-weight:800; letter-spacing:0.05em; text-transform:uppercase; padding:3px 8px; border-radius:99px; }
        .cc-badge-kast { background:rgba(79,142,247,0.1); color:#4f8ef7; border:1px solid rgba(79,142,247,0.2); }
        .cc-badge-redot { background:rgba(168,85,247,0.1); color:#a855f7; border:1px solid rgba(168,85,247,0.2); }
        .cc-stat { display:flex; align-items:baseline; gap:6px; }
        .cc-stat-num { font-size:32px; font-weight:900; letter-spacing:-0.04em; line-height:1; }
        .cc-stat-num-kast { color:#4f8ef7; }
        .cc-stat-num-redot { color:#a855f7; }
        .cc-stat-label { font-size:11px; color:rgba(255,255,255,0.4); font-weight:500; }
        .cc-perks { display:flex; flex-direction:column; gap:5px; }
        .cc-perk { font-size:12px; color:rgba(255,255,255,0.55); display:flex; align-items:center; gap:6px; }
        .cc-perk::before { content:''; display:inline-block; width:4px; height:4px; border-radius:50%; flex-shrink:0; }
        .cc-perk-kast::before { background:#4f8ef7; }
        .cc-perk-redot::before { background:#a855f7; }
        .cc-btn { display:block; text-align:center; font-size:12px; font-weight:800; padding:11px; border-radius:10px; text-decoration:none; margin-top:auto; }
        .cc-btn-kast { background:rgba(79,142,247,0.12); border:1px solid rgba(79,142,247,0.25); color:#4f8ef7; }
        .cc-btn-kast:hover { background:rgba(79,142,247,0.2); }
        .cc-btn-redot { background:rgba(168,85,247,0.12); border:1px solid rgba(168,85,247,0.25); color:#a855f7; }
        ...
        <div className="cc-section">
          <div className="cc-inner">
            <div className="cc-hdr">
              ...
              <p className="cc-sub">Spend crypto anywhere. Earn cashback on every purchase.</p>
            </div>
            <div className="cc-cards">
              <div className="cc-card cc-card-kast">
                <div className="cc-row1">
                  <span className="cc-brand cc-brand-kast">KAST</span>
                  <span className="cc-badge cc-badge-kast">Free Tier</span>
                </div>
                <div className="cc-stat">
                  <span className="cc-stat-num cc-stat-num-kast">3%</span>
                  <span className="cc-stat-label">USDC cashback on purchases</span>
                </div>
                <div className="cc-perks">
                  <span className="cc-perk cc-perk-kast">Up to 7% APY on idle balance</span>
                  <span className="cc-perk cc-perk-kast">170+ countries · Apple & Google Pay</span>
                  <span className="cc-perk cc-perk-kast">10 card designs incl. Pudgy Penguins</span>
                  <span className="cc-perk cc-perk-kast">Free virtual card to start</span>
                </div>
                <a href="https://www.kast.xyz/?ref=3alamiy" target="_blank" rel="noopener noreferrer sponsored" className="cc-btn cc-btn-kast">Get KAST Card Free →</a>
              </div>
              <div className="cc-card cc-card-redot">
                <div className="cc-row1">
                  <span className="cc-brand cc-brand-redot">RedotPay</span>
                  <span className="cc-badge cc-badge-redot">#1 by Volume</span>
                </div>
                <div className="cc-stat">
                  <span className="cc-stat-num cc-stat-num-redot">$445M</span>
                  <span className="cc-stat-label">volume processed in May 2026</span>
                </div>
                <div className="cc-perks">
                  <span className="cc-perk cc-perk-redot">0% crypto top-up fee</span>
                  <span className="cc-perk cc-perk-redot">Virtual card in minutes</span>
                  <span className="cc-perk cc-perk-redot">BTC, ETH, USDT, USDC supported</span>
                  <span className="cc-perk cc-perk-redot">Accepted worldwide via Visa</span>
                </div>
                <a href="https://url.hk/i/en/xjrxm" target="_blank" rel="noopener noreferrer sponsored" className="cc-btn cc-btn-redot">Get RedotPay Card →</a>
              </div>
            </div>
            <p className="cc-disc">Affiliate links — 3alamiy may earn a commission at no cost to you</p>
          </div>
        </div>
