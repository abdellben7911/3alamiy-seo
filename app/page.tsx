        ...
        <div style={{ padding: '48px 0', borderTop: '1px solid rgba(255,255,255,0.04)', borderBottom: '1px solid rgba(255,255,255,0.04)', background: 'linear-gradient(135deg, #060A12 0%, #0D1A2E 40%, #0A1628 60%, #060A12 100%)', position: 'relative' }}>
          ...
          <div className="tk-outer">
            <div className="tk-track">
              {[
                { name: 'Ethereum', logo: 'https://pbs.twimg.com/profile_images/2410503893/ieth_yzgj6_400x400.png' },
                { name: 'Solana', logo: 'https://pbs.twimg.com/profile_images/1485101901585510401/4QFGHsXv_400x400.jpg' },
                { name: 'Arbitrum', logo: 'https://pbs.twimg.com/profile_images/1489900898122211334/FHBS_8e9_400x400.jpg' },
                { name: 'Base', logo: 'https://pbs.twimg.com/profile_images/1721863647413354496/kCjFPCqJ_400x400.jpg' },
                { name: 'Hyperliquid', logo: 'https://pbs.twimg.com/profile_images/1880654761876905984/WF3pjD5X_400x400.jpg' },
                { name: 'Sui', logo: 'https://pbs.twimg.com/profile_images/1569268002681217024/oBHEfLpz_400x400.jpg' },
                { name: 'Optimism', logo: 'https://pbs.twimg.com/profile_images/1656233435828727808/nTbOGDEi_400x400.jpg' },
                { name: 'Polygon', logo: 'https://pbs.twimg.com/profile_images/1651847461104717825/QmSN9s6Q_400x400.jpg' },
                { name: 'Avalanche', logo: 'https://pbs.twimg.com/profile_images/1592707893172248576/7OTsaGiI_400x400.jpg' },
                { name: 'BNB Chain', logo: 'https://pbs.twimg.com/profile_images/1694188346680594432/LbMHPrAn_400x400.jpg' },
                { name: 'Aptos', logo: 'https://pbs.twimg.com/profile_images/1573780847842443264/qNnNHdOq_400x400.jpg' },
                { name: 'ZKSync', logo: 'https://pbs.twimg.com/profile_images/1777009886521397248/yzAMtWRW_400x400.jpg' },
                ...
                { name: 'Mantle', logo: 'https://pbs.twimg.com/profile_images/1664498244895158272/9NsKMDRo_400x400.jpg' },
