        ...
        <div style={{ padding: '48px 0', borderTop: '1px solid rgba(255,255,255,0.04)', borderBottom: '1px solid rgba(255,255,255,0.04)', background: 'linear-gradient(135deg, #060A12 0%, #0D1A2E 40%, #0A1628 60%, #060A12 100%)', position: 'relative' }}>
          ...
          <div className="tk-outer">
            <div className="tk-track">
              {[
                { name: 'Ethereum', logo: 'https://assets.trustwalletapp.com/blockchains/ethereum/info/logo.png' },
                { name: 'Solana', logo: 'https://assets.trustwalletapp.com/blockchains/solana/info/logo.png' },
                { name: 'Arbitrum', logo: 'https://assets.trustwalletapp.com/blockchains/arbitrum/info/logo.png' },
                { name: 'Base', logo: 'https://assets.trustwalletapp.com/blockchains/base/info/logo.png' },
                ...
                { name: 'Optimism', logo: 'https://assets.trustwalletapp.com/blockchains/optimism/info/logo.png' },
                { name: 'Polygon', logo: 'https://pbs.twimg.com/profile_images/1651847461104717825/QmSN9s6Q_400x400.jpg' },
                { name: 'Avalanche', logo: 'https://assets.trustwalletapp.com/blockchains/avalanchec/info/logo.png' },
                { name: 'BNB Chain', logo: 'https://assets.trustwalletapp.com/blockchains/smartchain/info/logo.png' },
                { name: 'Aptos', logo: 'https://assets.trustwalletapp.com/blockchains/aptos/info/logo.png' },
                { name: 'ZKSync', logo: 'https://assets.trustwalletapp.com/blockchains/zksync/info/logo.png' },
