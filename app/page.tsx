          ...
          <div className="tk-outer">
            <div className="tk-track">
              {[
                ...
                { name: 'Hyperliquid', logo: '/chains/hyperliquid.svg' },
                ...
                { name: 'Aptos', logo: '/chains/aptos.svg' },
                { name: 'ZKSync', logo: '/chains/zksync.svg' },
                { name: 'Monad', logo: '/chains/monad.svg' },
                { name: 'Linea', logo: '/chains/linea.svg' },
                { name: 'Starknet', logo: '/chains/starknet.svg' },
                { name: 'Pharos', logo: '/chains/pharos.svg' },
                { name: 'Mantle', logo: '/chains/mantle.svg' },
                { name: 'Blast', logo: '/chains/blast.svg' },
                { name: 'HyperEVM', logo: '/chains/hyperevm.svg' },
                { name: 'Abstract', logo: '/chains/abstract.svg' },
                { name: 'Scroll', logo: '/chains/scroll.svg' },
                { name: 'Taiko', logo: '/chains/taiko.svg' },
              ].concat([
                { name: 'Ethereum', logo: '/chains/ethereum.svg' },
                { name: 'Solana', logo: '/chains/solana.svg' },
                { name: 'Arbitrum', logo: '/chains/arbitrum.svg' },
