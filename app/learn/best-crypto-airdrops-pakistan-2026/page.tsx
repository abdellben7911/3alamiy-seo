  ...
  return (
    <>
      ...
      <style>{`
        ...
        .pk-card-dual-box{display:flex;gap:10px;margin-bottom:32px;flex-wrap:wrap}
        .pk-card-btn{flex:1;min-width:140px;display:flex;align-items:center;justify-content:space-between;gap:8px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.1);border-radius:12px;padding:14px 16px;text-decoration:none;transition:border-color .2s}
        .pk-card-btn:hover{border-color:rgba(255,255,255,0.25)}
        .pk-card-btn-left{text-align:left}
        .pk-card-tag{font-size:9px;font-weight:800;letter-spacing:0.1em;text-transform:uppercase;color:rgba(255,255,255,0.3);margin-bottom:3px}
        .pk-card-name{font-size:13px;font-weight:700;color:#fff}
        .pk-card-perk{font-size:11px;color:rgba(255,255,255,0.4);margin-top:1px}
        .pk-card-arrow{font-size:14px;color:rgba(255,255,255,0.25);flex-shrink:0}
      `}</style>
      ...
      <main className="pk">
        <div className="pk-wrap">
          ...
          {/* CTA */}
          <div className="pk-card-dual-box">
            <a href="https://app.kast.xyz/referral/M9F7SPDV" target="_blank" rel="noopener noreferrer sponsored" className="pk-card-btn">
              <div className="pk-card-btn-left">
                <div className="pk-card-tag">Crypto Card</div>
                <div className="pk-card-name">KAST Card</div>
                <div className="pk-card-perk">Up to 12% cashback</div>
              </div>
              <span className="pk-card-arrow">→</span>
            </a>
            <a href="https://url.hk/i/en/xjrxm" target="_blank" rel="noopener noreferrer sponsored" className="pk-card-btn">
              <div className="pk-card-btn-left">
                <div className="pk-card-tag">Crypto Card</div>
                <div className="pk-card-name">RedotPay Card</div>
                <div className="pk-card-perk">$445M volume · 6% cashback</div>
              </div>
              <span className="pk-card-arrow">→</span>
            </a>
          </div>
