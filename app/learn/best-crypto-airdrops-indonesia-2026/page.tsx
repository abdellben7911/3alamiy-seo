  ...
  return (
    <>
      ...
      <style>{`
        ...
        .idn-card-dual-box{display:flex;gap:10px;margin-bottom:32px;flex-wrap:wrap}
        .idn-card-btn{flex:1;min-width:140px;display:flex;align-items:center;justify-content:space-between;gap:8px;background:rgba(255,255,255,0.04);border:1px solid rgba(255,255,255,0.1);border-radius:12px;padding:14px 16px;text-decoration:none;transition:border-color .2s}
        .idn-card-btn:hover{border-color:rgba(255,255,255,0.25)}
        .idn-card-btn-left{text-align:left}
        .idn-card-tag{font-size:9px;font-weight:800;letter-spacing:0.1em;text-transform:uppercase;color:rgba(255,255,255,0.3);margin-bottom:3px}
        .idn-card-name{font-size:13px;font-weight:700;color:#fff}
        .idn-card-perk{font-size:11px;color:rgba(255,255,255,0.4);margin-top:1px}
        .idn-card-arrow{font-size:14px;color:rgba(255,255,255,0.25);flex-shrink:0}
      `}</style>
      <main className="idn">
        <div className="idn-wrap">
          ...
          <div className="idn-card-dual-box">
            <a href="https://app.kast.xyz/referral/M9F7SPDV" target="_blank" rel="noopener noreferrer sponsored" className="idn-card-btn">
              <div className="idn-card-btn-left">
                <div className="idn-card-tag">Crypto Card</div>
                <div className="idn-card-name">KAST Card</div>
                <div className="idn-card-perk">Up to 12% cashback</div>
              </div>
              <span className="idn-card-arrow">→</span>
            </a>
            <a href="https://url.hk/i/en/xjrxm" target="_blank" rel="noopener noreferrer sponsored" className="idn-card-btn">
              <div className="idn-card-btn-left">
                <div className="idn-card-tag">Crypto Card</div>
                <div className="idn-card-name">RedotPay Card</div>
                <div className="idn-card-perk">$445M volume · 6% cashback</div>
              </div>
              <span className="idn-card-arrow">→</span>
            </a>
          </div>
