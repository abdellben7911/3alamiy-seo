...
const allArticles = [
  ...
  { slug: 'best-crypto-airdrops-july-2026', title: 'Best Crypto Airdrops July 2026 — 7 to Farm This Month', description: 'MetaMask Franky SBT live. Berachain Kodiak V3 BGT emissions active. 7 airdrops ranked by reward potential for July 2026.', badge: 'Hot', badgeColor: '#7CF5C0', catColor: '#7CF5C0', time: '6 min' },
  { slug: 'best-crypto-airdrops-june-2026', title: 'Best Crypto Airdrops June 2026 — Updated Weekly', description: 'Top airdrops ranked by potential reward for June 2026. Hyperliquid S2, MetaMask, Phantom, Soneium, MegaETH. Updated every week.', badge: 'Archive', badgeColor: '#6b7280', catColor: '#6b7280', time: '6 min' },
  ...
  { slug: 'ronaldo-wedding-prediction-markets-2026', title: '2,000 Fans, the Wrong Bride, and a Wedding That Never Happened', desc: 'Every outlet reported August 8. Nobody confirmed it. 2,000 fans mobbed Funchal Cathedral and found a local couple. A case study in how prediction markets price rumor.', badge: 'Breaking', badgeColor: '#f87171', cat: 'Markets', catColor: '#60a5fa', time: '6 min' },
  { slug: 'best-crypto-airdrops-august-2026', title: 'Best Crypto Airdrops August 2026 — 7 to Farm This Month', desc: 'Grass S2 USDC claims open until Jan 2027. Hyperliquid S2 ongoing. MetaMask Franky SBT still open. Backpack $37M confirmed pool. 7 airdrops ranked.', badge: 'Hot', badgeColor: '#7CF5C0', cat: 'Monthly', catColor: '#7CF5C0', time: '7 min' },
  { slug: 'best-crypto-airdrops-south-africa-2026', title: 'Best Crypto Airdrops for South Africans 2026 — Free, No Investment', desc: "Africa's top crypto market with FSCA-licensed exchanges. Fund via VALR, Luno, or Binance P2P. 7 airdrops ranked by reward potential.", badge: 'New', badgeColor: '#16a34a', cat: 'Geo', catColor: '#16a34a', time: '7 min' },
  { slug: 'best-crypto-airdrops-ghana-2026', title: 'Best Crypto Airdrops for Ghanaians 2026 — Free, No Investment', desc: "West Africa's fast-growing crypto market. Fund via MTN MoMo or Binance P2P. 7 airdrops accessible from Ghana with no VPN.", badge: 'New', badgeColor: '#d97706', cat: 'Geo', catColor: '#d97706', time: '7 min' },
