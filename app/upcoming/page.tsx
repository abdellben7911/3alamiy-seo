...
const PROJECTS = [
  {
    ...
    chainColor: '#627EEA',
    logo: '🔷',
    tagline: 'EVM-compatible L1 with 10,000 TPS. Biggest L1 to watch in 2026.',
    funding: '$244M',
    ...
    statusColor: '#7CF5C0',
    tasks: [
      'Use Monad Testnet — bridge ETH and make swaps daily',
      'Use testnet DEXes: Ambient, Kuru, Uniswap v3 port',
      'Deploy a contract or mint an NFT on testnet',
      'Join Monad Discord and complete onboarding quests',
      'Follow @monad_xyz and engage with posts',
    ],
  },
  {
    name: 'MegaETH',
    ...
    chainColor: '#627EEA',
    logo: '⚡',
    tagline: 'Real-time blockchain — 100,000 TPS Ethereum L2. No token yet.',
    funding: '$20M',
    investors: 'Dragonfly, Figma founders',
    hypeScore: 92,
    rewardTier: '$$$',
    rewardEst: '$200–$2,000',
    risk: 'Low',
    ...
    statusColor: '#7CF5C0',
    tasks: [
      'Bridge ETH to MegaETH testnet via official bridge',
      'Use MegaETH ecosystem apps daily (swaps, lending)',
      'Mint grassroots NFTs on testnet',
      'Complete quests on Galxe and Layer3 for MegaETH',
      'Hold testnet activity for at least 3 months',
    ],
  },
  {
    name: 'Story Protocol',
