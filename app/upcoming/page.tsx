...
export const metadata: Metadata = {
  ...
  keywords: 'upcoming crypto airdrops 2026, tokenless projects 2026, potential airdrops, best airdrops to farm, monad airdrop, megaeth airdrop, story protocol airdrop, movement airdrop, aztec ecosystem airdrop',
